package cn.hyqup.auth.authentication.granter;

import cn.hyqup.auth.authentication.mobilepwd.MobilePwdAuthenticationToken;
...
public class MobilePwdGranter extends AbstractTokenGranter {
    ...
    protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
        ...
        Authentication userAuth = new MobilePwdAuthenticationToken(mobile, password);
